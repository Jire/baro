...
public interface User32 extends StdCallLibrary {
	...
	public static class FLASHWINFO extends Structure {
		...
		protected List<String> getFieldOrder() {
			return Arrays.asList("cbSize", "hWnd", "dwFlags", "uCount",
					"dwTimeout");
		}
	}
	...
	public static class GUITHREADINFO extends Structure {
		...
		protected List<String> getFieldOrder() {
			return Arrays
					.asList("cbSize", "flags", "hwndActive", "hwndFocus",
	...
	public static class WINDOWINFO extends Structure {
		...
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("cbSize", "rcWindow", "rcClient", "dwStyle",
					"dwExStyle", "dwWindowStatus", "cxWindowBorders",
					"cyWindowBorders", "atomWindowType", "wCreatorVersion");
		}
	}
	...
	int GetWindowModuleFileName(Pointer hWnd, byte[] lpszFileName,
			int cchFileNameMax);
	...
	boolean SetLayeredWindowAttributes(Pointer hwnd, int crKey, byte bAlpha,
			int dwFlags);

	boolean GetLayeredWindowAttributes(Pointer hwnd, IntByReference pcrKey,
	...
	public static class BLENDFUNCTION extends Structure {
		...
		@Override
		protected List<String> getFieldOrder() {
			return Arrays.asList("BlendOp", "BlendFlags",
					"SourceConstantAlpha", "AlphaFormat");
		}
	}

	boolean UpdateLayeredWindow(Pointer hwnd, Pointer hdcDst, POINT pptDst,
			SIZE psize, Pointer hdcSrc, POINT pptSrc, int crKey,
